...
async function default_1(fastify) {
    ...
    fastify.get('/scenarios/detail/current_user_scenarios', async (request, response) => {
        const mockData = [
            {
                scenarioId: 1,
                relationship: type_1.Relationship.GoodFriend,
                depressionLevel: type_1.DepressionLevel.Mild,
                histories: [],
            },
            {
                scenarioId: 2,
                relationship: type_1.Relationship.Parent,
                depressionLevel: type_1.DepressionLevel.Moderate,
                histories: [],
            },
            // {
            // scenarioId: 3,
